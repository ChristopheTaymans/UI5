sap.ui.define([
		...
		"be/infra/sap/mobile/devicelist/model/formatter",
		"sap/ui/model/Filter",
		...
		return BaseController.extend("be.infra.sap.mobile.devicelist.controller.Worklist", {
				...
				if (oEvent.getParameters().refreshButtonPressed) {
					...
					if (sQuery && sQuery.length > 0) {
						...
						oTableSearchState = [ 
						        new  Filter({
						        	filters: [
						        	      new Filter("Deviceid", FilterOperator.Contains, sQuery),
//							              new Filter("Uname", FilterOperator.Contains, sQuery),
//							              new Filter("Lastping", FilterOperator.Contains, sQuery)
						        	],
							        and: false
						        	})
			...
			_showObject : function (oItem) {
				this.getRouter().navTo("object", {
					objectId: oItem.getBindingContext().getProperty("Deviceid")
				});
			},
