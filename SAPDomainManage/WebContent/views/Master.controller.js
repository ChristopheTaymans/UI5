...
sap.ui.define(
    [
      ...
      function (BaseController, SAPJsonModel, Filter) {       
        return BaseController.extend("SAPDomainManage.Application.views.Master", {            /**
            ...
            _onItemPress : function(oEvent){            	
            	...
            	if (this.getModel("Saved").getData().Save){
	            	this.getRouter().navTo(
	            			"domainRoute", {
	            				Domain:sPath.substr(1)
	            			}
	            		)  
            	}
            },
            
            onDomainSearch : function (oEvt) {
    			...
    			// update list binding
    			var list = this.getView().byId("lstDomain");
